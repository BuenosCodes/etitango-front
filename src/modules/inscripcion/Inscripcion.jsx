...
export default function Inscripcion() {
    ...
    const SignupSchema = object({
        ...
        province: string().nullable(true).when("country", {
            is: "Argentina",
            then: string().nullable(true).required("Este campo no puede estar vacío")
        }),
        city: string().nullable(true).when("country", {
            is: "Argentina",
            then: string().nullable(true).required("Este campo no puede estar vacío")
        }),
                                                ...
                                                <Grid container justifyContent="flex-end">
                                                    <Grid item>
                                                        <Button variant="contained" color="secondary" type="submit"
                                                                disabled={isSubmitting}>{t(`${SCOPES.MODULES.SIGN_UP}.signUp`)}</Button>
                                                    </Grid>
                                                </Grid>
                                                <Grid item style={{textAlign: 'center'}}>
                                                    <Typography variant="caption">
                                                        {t(`${SCOPES.MODULES.SIGN_UP}.disclaimer`)}<b>martes 28 de
                                                        junio</b>.<br/>
