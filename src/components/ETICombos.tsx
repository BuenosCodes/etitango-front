...
export default function ETICombos(props: { proPackage: string; onChange: Function }) {
  const { proPackage, onChange } = props;
                        ...
                        <Form>
                          ...
                          <Grid container gap={2}>
                            <Grid item md={12} sm={12} xs={12}>
                              <Typography
                                sx={{ color: '#424242', fontWeight: 500, fontSize: '20px' }}
                              >
                                Combos
                              </Typography>
